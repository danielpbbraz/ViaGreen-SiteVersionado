...
<nav id="menu-lateral">
	...
	<div class="middle">
		...
		<ul>
			...
			<li><a href="produtos/compensacao" <?php echo $action == 'compensacao' ? 'class="active"' : ''; ?>>COMPENSACIÓN DE CARBONO</a></li>
			<li><a href="produtos/projetos" <?php echo $action == 'projetos' ? 'class="active"' : ''; ?>>PROYECTOS</a></li>
			<li><a href="produtos/plantio_de_arvores" <?php echo $action == 'plantio_de_arvores' ? 'class="active"' : ''; ?>>PLANTACIÓN DE ÁRBOLES</a></li>
			<li><a href="produtos/ecommerce" <?php echo $action == 'ecommerce' ? 'class="active"' : ''; ?>>E-COMMERCE</a></li>
			<li><a href="produtos/mudancas" <?php echo $action == 'mudancas' ? 'class="active"' : ''; ?>>CAMBIOS CLIMÁTICOS</a></li>
		</ul>
	</div>
</nav>