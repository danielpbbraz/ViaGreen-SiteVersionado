<main>
	<div class="banner banner-internal-top pag-banner">
		...
		<div class="center">
			<h1 data-ani-type="fade-top" data-ani-delay=".2">Contato</h1>
		</div>
	</div>
	<section id="section-contact" class="center">
		...
		<div class="form" data-ani-type="fade-top" data-ani-delay=".2">
			<form id="form-contact" method="post">
				...
				<label>
					<textarea name="message" required="required" placeholder="Mensagem"></textarea>
				</label>
		...
		<div class="map" data-ani-type="fade-top" data-ani-delay=".2">
			...
			<a href="https://maps.google.com/maps?ll=-23.936803,-46.321859&z=16&t=m&hl=pt-BR&gl=BR&mapclient=embed&q=R.%20Amador%20Bueno%2C%20333%20-%20Centro%20Santos%20-%20SP%2011013-151" class="lk-external-map" target="_blank">ABRIR NO GOOGLE MAPS</a>
			<address>
	...
	<section class="work">
		<div class="center">
			<h2 data-ani-type="fade-top" data-ani-delay=".2">TRABALHE CONOSCO</h2>
			<div class="email" data-ani-type="fade-top" data-ani-delay=".2">
				<p class="light">Faça parte da nossa equipe.</p>
				<p class="txt-send">Envie seu curriculo para <a href="mailto:trabalhe@viagreen.org.br">trabalhe@viagreen.org.br</a></p>
			</div>
		</div>
	</section>
</main>